...
class ServerConfig(EnvLoadable, PartMixin, DictMixin):
    ...
    base_url: str = Attr(default=None, env="SERVER_BASE_PATH")
    static_path: str = Attr(default=None, env="SERVER_STATIC_PATH")
    config_file: str = Attr(default=None, env="SERVER_CONFIG_FILE")
...
def init_server_config() -> ServerConfig:
